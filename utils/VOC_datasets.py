...
dict_classes = dict_labels


class Read_data(Dataset):
    def __init__(self, root_path):
        super(Read_data).__init__()
        ...
        self.img_path = self.root_path + "/JPEGImage/存放.jpg图片的地址"
        self.anno_path = self.root_path + "/Annotations/存放annotation标注.xml文件的地址"
...
train_data = Read_data(root_path=Voc_data_path)
